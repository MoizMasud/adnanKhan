...
// Realtor.ca URL - update this with Adnan's actual profile/search URL
const realtorSearchUrl = "https://www.realtor.ca/agent/2063458/adnan-khan-215-queen-st-w-unit-201b-cambridge-ontario-n3c1g6";
    ...
    <div className="container mx-auto px-4 py-8 sm:py-12">
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3">
          {/* Results Header with Realtor.ca Link */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="font-body text-sm text-[#0a131e] hover:text-[#6c757d] transition-colors flex items-center gap-1.5 group"
            >
              See full live MLS search on Realtor.ca
