...
const Navigation = () => {
  ...
  const navLinks = [
    ...
    { name: 'Search Homes', href: 'https://www.realtor.ca/', external: true },
    { name: 'Featured Listings', href: 'https://www.realtor.ca/map#Sort=6-D&IndividualId=2063458&IncludePins=1&Currency=CAD', external: true },
