  ...
  if (!isMobile) {
    return (
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6 space-y-6">
        ...
        <button
          type="submit"
          className="w-full font-button tracking-wider bg-white hover:bg-[#0a131e] text-[#0a131e] hover:!text-white border-2 border-[#0a131e] py-3 px-6 rounded-md transition-all duration-300 shadow-md hover:shadow-lg"
        >
          SEARCH PROPERTIES
        </button>
      </form>
